            ...
            <tr>
              ...
              <th scope="col" className="px-6 py-3">
                <div className="px-6 py-4 flex items-center w-full">
                  <span className="flex items-center w-full">Auto Renew</span>
                </div>
              </th>
            ...
            {sortedDomains.map((domain: TDomain) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 w-full flex align-middle">
                    <span className={domain.AutoRenew || domain.renewAuto ? 'text-green-500' : 'text-red-500'}>
                      {domain.AutoRenew || domain.renewAuto ? 'Yes' : 'No'}
                    </span>
                  </td>
